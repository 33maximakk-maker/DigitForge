// digital_clock.rs - Цифровые часы на Rust (веб-сервер)
use actix_web::{web, App, HttpResponse, HttpServer, Result};

async fn index() -> HttpResponse {
    let html = r#"<!DOCTYPE html>
<html><head><meta charset="UTF-8"><title>🕐 DigitForge - Rust</title>
<style>*{margin:0;box-sizing:border-box;}body{background:#000;display:flex;justify-content:center;align-items:center;min-height:100vh;font-family:'Courier New',monospace;}
